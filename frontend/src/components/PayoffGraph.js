...
const PayoffGraph = () => {
  return (
    <div className="flex min-w-72 flex-1 flex-col gap-2">
      <p className="text-white text-base font-medium leading-normal">Payoff Graph</p>
      <p className="text-white tracking-light text-[32px] font-bold leading-tight truncate">$1,234</p>
      <div className="flex gap-1">
        <p className="text-[#9aafbc] text-base font-normal leading-normal">Today</p>
        <p className="text-[#0bda57] text-base font-medium leading-normal">+2.5%</p>
      </div>
